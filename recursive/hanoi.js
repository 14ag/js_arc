import { println, assertEqual } from "../utils";
/*<1>
...
<2>
Make a recursive function call to move the disks sitting on top of the bottom disk
 on the fromPeg to the spare peg, i.e. move (numDisks - 1) disks to the spare peg.
...
<4>
Make a recursive function call to move the disks from the spare peg back
 on top of the bottom disk, i.e. move (numDisks - 1) disks from the spare peg to the target peg.
<5>
 Uncomment the call to solveHanoi and the Program.assertEqual statement below
  your solveHanoi function, and press the Restart button to test out your solveHanoi function.
Every time you call moveDisk, the move will be recorded in the console window. 
If your function attempts to make an invalid move, the moveDisk function will print
 an error message in the console and block further calls to moveDisk.
  To call moveDisk after you have made an invalid move, you will need to press the 'Restart' button.
